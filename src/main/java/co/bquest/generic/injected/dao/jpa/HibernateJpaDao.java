...
public class HibernateJpaDao<E extends Serializable, K> implements JpaDao<E, K> {
    ...
    public void create(E e) {
        log.log(Level.INFO, "Creando entidad de tipo {0}", entityClass.getSimpleName());
        em.persist(e);
        em.flush();
    }
    ...
    public void update(E e) {
        log.log(Level.INFO, "Actualizando entidad de tipo {0}", entityClass.getSimpleName());
        em.merge(e);
        em.flush();
    }
    ...
    public void delete(K id) {
        log.log(Level.INFO, "Eliminando entidad de tipo {0}", entityClass.getSimpleName());
    ...
    public void createBatch(Collection<E> e) {
        log.log(Level.INFO, "Creando [{0}] entidades de tipo {1}", new Object[]{e.size(), entityClass.getSimpleName()});
    ...
    public void updateBatch(Collection<E> e) {
        log.log(Level.INFO, "Actualizando [{0}] entidades de tipo {1}", new Object[]{e.size(), entityClass.getSimpleName()});
    ...
    public void deleteBatch(Collection<K> ids) {
        log.log(Level.INFO, "Eliminando [{0}] entidades de tipo {1}", new Object[]{ids.size(), entityClass.getSimpleName()});
